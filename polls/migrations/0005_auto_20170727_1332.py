    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bioinfo_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.BioInfo')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
        ...
        migrations.AddField(
            model_name='projects',
            name='runprocess_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.RunProcess'),
        ),
        migrations.AddField(
            model_name='projects',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.UserInfo'),
        ),
    ]
