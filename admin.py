...
class MachinesAdmin (admin.ModelAdmin) :
	list_display=('machineName','machineDescription', 'machineLocation','machineProvider','machineSerialNumber', 'machineState','machineOperationStart','machineOperationEnd')
