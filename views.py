...
## Called by menu "Run preparation" >> "Upload the run"
    ...
    if request.method == 'POST' and (request.POST['action']=='uploadFile'):
        ...
        ## Error page is showed if file does not contain the csv extension
        if ext_file != '.csv':
            return render (
                request,'iSkyLIMS_wetlab/error_page.html',
        ...
        ## CHECK that runName is not already used in the database.
        #import pdb; pdb.set_trace()
        check_run_name_result =check_run_name_free_to_use(run_name,sequencer)
        if check_run_name_result != 'Free':
            return render (
                request,'iSkyLIMS_wetlab/error_page.html',
        ...
        ## Error page is showr if not project/description colunms are found
        ...
        (projects_in_run_result, form_message)= check_existence_projects_in_run(stored_file)
        if projects_in_run_result==  0 :
            ## delete sample sheet file
            fs.delete(file_name)
            return render (
                request,'iSkyLIMS_wetlab/error_page.html',
