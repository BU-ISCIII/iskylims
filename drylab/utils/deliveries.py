...
def prepare_delivery_form(resolution_id):
    ...
    Functions:
        get_resolution_obj_from_id # located at drylab.utils.handling_resolutions
        get_pipelines_for_service     # located at drylab.utils.handling_pipelines
    ...
    if resolution_obj is not None:
        ...
        delivery_data_form[
            "pipelines_data"
        ] = drylab.utils.handling_pipelines.get_pipelines_for_resolution(
            resolution_obj
        )
...
def store_resolution_delivery(form_data):
    ...
    Functions:
        get_resolution_obj_from_id # located at drylab.utils.handling_resolutions
        get_pipelines_for_service     # located at drylab.utils.handling_pipelines
        get_pipeline_obj_from_id       # located at drylab.utils.handling_pipelines
    Return:
        delivery_data
    """
    delivery_data = None
