...
OUTPUT_DIR_SERVICE_REQUEST_PDF = (
    "documents/drylab/service_request"  # Directory to store service request pdf
)
OUTPUT_DIR_RESOLUTION_PDF = (
    "documents/drylab/resolution"  # Directory to store resolution pdf
)
...
CONFIRMATION_TEXT_MESSAGE = [
    "Your service request has been successfully recorded.",
    "The sequence number assigned for your request is: SERVICE_NUMBER",
    "Keep this number safe for refering your request",
...
ERROR_UNABLE_TO_RECORD_YOUR_SERVICE = [
    "Your service request cannot be recorded.",
...
ERROR_NO_MATCHES_FOUND_FOR_YOUR_SERVICE_SEARCH = [
    "There is not any Service that matches your input conditions"
]

ERROR_PIPELINE_ALREADY_EXISTS = ["Pipeline name and version is already defined"]

ERROR_NO_SERVICES_ARE_SELECTED = [
...
HEADING_PIPELINES_USED_IN_RESOLUTIONS = [
    "Pipeline name",
    "Pipeline version",
    "Used in Resolution",
]
...
HEADING_SERVICE_DATES = [
    "Service Date Creation",
    "Approval Service Date",
    "Rejected Service Date",
...
ERROR_RESOLUTION_DOES_NOT_EXISTS = [
    "The resolution that you are trying to upadate does not exists ",
    "Contact with your administrator .",
]

HEADING_PIPELINES_SELECTION_IN_RESOLUTION = [
    "Pipeline name",
    "Pipeline version",
    "Pipeline ID",
]
...
MAPPING_ADDITIONAL_RESOLUTION_PARAMETERS = [
    ("resolution_parameter", "Parameter name"),
    ("resolution_param_value", "Parameter value"),
...
BODY_SERVICE_RECORDED = [
    "Dear USER_NAME",
    "Your service  SERVICE_NUMBER has been recorded.",
    "You will received the resolution of the request as soon as possible.",
    "Kind regards",
    "BU-ISCIII",
]
