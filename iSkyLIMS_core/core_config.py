...
ERROR_MESSAGE_FOR_SAMPLE_BATCH_FILE_NOT_SAMPLE_FIELD_DEFINED =['Required sample project field', 'is not included in batch file']
ERROR_MESSAGE_FOR_SAMPLE_BATCH_FILE_MOLECULE_NOT_DEFINED = ['The mandatory field for molecule' , 'must be included in the batch file']
ERROR_MESSAGE_FOR_SAMPLE_BATCH_FILE_NO_DEFINED_MOLECULE_TYPES = ['No molecule types are defined yet', 'Check documentation to define them']
