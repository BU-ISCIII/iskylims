...
urlpatterns = [
    ...
    path(
        "createNewPatientProject",
        views.create_new_patient_project,
        name="create_new_patient_project",
    ),
    path("createProtocol", views.create_protocol, name="create_protocol"),
    path(
        "createSampleProjects",
        views.create_sample_projects,
        name="create_sample_projects",
    ),
    path(
        "defineExtractionMolecules",
        views.define_extraction_molecules,
        name="define_extraction_molecules",
    ),
    path(
        "defineProjectFields=<int:project_id>",
        views.define_project_fields,
        name="define_project_fields",
    ),
    path("defineNewPatient", views.define_new_patient, name="define_new_patient"),
    path(
        "defineNewPatientHistory",
        views.define_new_patient_history,
        name="define_new_patient_history",
    ),
    ...
    path(
        "displayPatientProject=<int:project_id>",
        views.display_patient_project,
        name="display_patient_project",
    ),
    path(
    ...
    path(
        "displayPatientInformation=<int:patient_id>/",
        views.display_patient_information,
        name="display_patient_information",
    ),
    path(
        "displaySampleClinicInfo=<int:sample_c_id>",
        views.display_sample_clinic_info,
        name="display_sample_clinic_info",
    ),
    path(
