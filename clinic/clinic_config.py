...
HEADING_FOR_DISPLAY_SAMPLE_MAIN_INFORMATION = [
    "Sample Origin",
    "Type of Sample",
    "Species",
    "Entry Date",
...
HEADING_FOR_DISPLAY_SAMPLE_DEFINED_STATE = [
    "Sample Name",
    "Sample Origin",
    "Type of Sample",
    "Species",
...
ERROR_MESSAGE_FOR_INCORRECT_START_SEARCH_DATE = [
    'The format for the "Start Date Search" Field is incorrect ',
    "Use the format  (DD-MM-YYYY)",
]

ERROR_MESSAGE_FOR_INCORRECT_END_SEARCH_DATE = [
    'The format for the "End Date Search" Field is incorrect ',
    "Use the format  (DD-MM-YYYY)",
]

ERROR_MESSAGE_FOR_SORT_PATIENT_NAME = [
    "The Patient name must contains more than 4 characters"
]

ERROR_MESSAGE_FOR_NO_MATCH_IN_SEARCH = ["Your query did not return any results"]

ERROR_MESSAGE_FOR_INVALID_PATIENT_BATCH_FILE = [
    "The patient batch file deos not have the right number of colunms"
]

ERROR_MESSAGE_FOR_EMPTY_PATIENT_BATCH_FILE = [
    "Patient batch file does not have any patient data"
]
ERROR_MESSAGE_NOT_VALID_PROJECT_IN_BATCH_FILE = [
    "The following Patient Project is not defined"
]
# FIELDS NAME USED IN USER FORM  #
FORM_MAIN_DATA_PATIENT_DEFINITION = [
    "patientName",
    "patientSurname",
    "patientCode",
    "patientSex",
]
FORM_OPT_DATA_PATIENT_DEFINITION = [
    "address",
    "phone",
    "email",
    "birthday",
...
HEADING_SEARCH_LIST_SAMPLES_CLINIC = [
    "Sample Clinic name",
    "History Number ",
    "Doctor name",
    "Priority",
...
HEADING_FOR_RESULT_TO_PROTOCOL = [
    "Clinic Sample",
    "History Number",
    "Priority",
    "Protocol Type",
...
MAPPING_SAMPLES_CORE_VS_CLINIC = {
    "Defined": "Patient update",
    "Extract molecule": "Sequencing",
    "Library preparation": "Sequencing",
    "Pool Preparation": "Sequencing",
    "Sequencing": "Sequencing",
    "Completed": "Pending protocol",
    "Error": "Invalid",
}
