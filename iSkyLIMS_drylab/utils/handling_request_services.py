...
def prepare_form_data_request_service_sequencing (request):
    ...
    service_data_information['nodes'] = AvailableService.objects.filter(availServiceDescription__exact="Genomic data analysis", inUse = True).get_descendants(include_self=True)
