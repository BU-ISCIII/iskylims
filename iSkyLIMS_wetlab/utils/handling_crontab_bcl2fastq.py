...
def check_demultiplexing_folder_exists(conn, run_folder, experiment_name):
    ...
    bcl2fastq_finish_date = ''
    statistics_folder = os.path.join(get_samba_application_shared_folder(), run_folder, DEMULTIPLEXION_BCL2FASTQ_FOLDER, STATS_FOLDER)
    ...
    try:
        ...
        logger.debug('%s : End function check_demultiplexing_folder_exists with warning', experiment_name)
        return {'ERROR': 29}
