...
def get_run_graphics(run_object):
    ...
    folder_graphic = os.path.join(
        settings.MEDIA_URL,
        wetlab_config.RUN_IMAGES_DIRECTORY,
...
def get_information_project(project_id, request):
    ...
    if len(run_objs) == 1:
        ...
        if StatsFlSummary.objects.filter(
            ...
            project_info_dict[
                "fl_summary_heading"
            ] = wetlab_config.HEADING_SINGLE_PROJECT_FL_SUMMARY
            # fl_data_display.append(fl_list)
        ...
        if StatsLaneSummary.objects.filter(
            ...
            ] = wetlab_config.HEADING_SINGLE_PROJECT_STATS_LANE
        ...
        if SamplesInProject.objects.filter(
            ...
            project_info_dict[
                "sample_heading"
            ] = wetlab_config.HEADING_SINGLE_PROJECT_SAMPLES
