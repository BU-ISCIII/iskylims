    ...
    if request.method == "POST":
        ...
        if start_date != "" and end_date != "":
            ...
            if RunProcess.objects.filter(
                ...
                stat_per_time["run_period_graphic"] = FusionCharts(
                    "column3d",
                ...
                if RunProcess.objects.filter(
                    ...
                    if Projects.objects.filter(runProcess__in=run_objs).exists():
                        ...
                        stat_per_time["project_period_graphic"] = FusionCharts(
                            "column3d",
                            run_period_index_graph,
                            "550",
                            "350",
                ...
                stat_per_time["disk_space_period_graphic"] = FusionCharts(
                    "column3d",
    ...
    if request.method == "POST":
        ...
        if len(library_names) == 1:
            ...
            for lane_number in range(1, 5):
                ...
                yield_mb_lane_graphic = FusionCharts(
                    "column3d",
                    render_number,
                    "500",
                    "300",
                ...
                mean_lane_graphic = FusionCharts(
                    "column3d",
                    render_number,
                    "400",
                    "300",
            ...
            comp_q30_lib_graphic = FusionCharts(
                "column3d",
                "comp-q30-1",
                "500",
                "300",
            ...
            comp_mean_lib_graphic = FusionCharts(
                "column3d",
                "comp-mean-1",
                "500",
                "300",
            ...
            lib_q30_lib_graphic = FusionCharts(
                "column3d",
                "lib-q30-lib",
                "500",
                "300",
            ...
            lib_mean_lib_graphic = FusionCharts(
                "column3d",
                "lib-mean-lib",
                "500",
                "300",
            ...
            libraries_kit_utilization = FusionCharts(
                "pie3d",
...
def annual_report(request):
    ...
    if request.method == "POST":
        ...
        graphic_completed_run = FusionCharts(
        ...
        aligned_year_graphic = FusionCharts(
            "column3d",
            "aligned_year",
            "600",
            "300",
        ...
        error_rate_year_graphic = FusionCharts(
            "column3d",
            "error_rate_year",
            "600",
            "300",
        ...
        p_user_year_graphic = FusionCharts(
            "column3d",
        ...
        pie_p_user_year_graphic = FusionCharts(
            "pie3d",
...
def monthly_report(request):
    ...
    if request.method == "POST":
        ...
        p_user_monthly_graphic = FusionCharts(
            "column3d",
        ...
        pie_p_user_monthly_graphic = FusionCharts(
            "pie3d",
        ...
        aligned_month_graphic = FusionCharts(
            "column3d",
            "aligned_year",
            "600",
            "300",
        ...
        error_rate_month_graphic = FusionCharts(
            "column3d",
            "error_rate_year",
            "600",
            "300",
        ...
        q30_month_graphic = FusionCharts(
            "column3d", "q30_year", "600", "300", "q30_chart-2", "json", data_source
        )
...
def quarter_report(request):
    ...
    if request.method == "POST":
        ...
        aligned_quarter_graphic = FusionCharts(
            "column3d",
            "aligned_year",
            "600",
            "300",
        ...
        error_rate_quarter_graphic = FusionCharts(
            "column3d",
            "error_rate_year",
            "600",
            "300",
        ...
        q30_quarter_graphic = FusionCharts(
            "column3d", "q30_year", "600", "300", "q30_chart-2", "json", data_source
        )
        #
        ...
        p_user_quarter_graphic = FusionCharts(
            "column3d",
            "bar_project_user_year",
            "400",
            "300",
        ...
        pie_p_user_quarter_graphic = FusionCharts(
            "pie3d",
            "pie_project_user_year",
            "400",
            "300",
    ...
    if RunProcess.objects.filter(
        ...
        for run_be_updated in run_list_be_updated:
            ...
            get_full_list = conn.listPath(
                wetlab_config.SAMBA_SHARED_FOLDER_NAME, runID_value
            )
            rest_of_dir_size = 0
            data_dir_size = 0
            images_dir_size = 0
        ...
        for run_be_updated in run_list_be_updated:
            ...
            try:
                completion_attributes = conn.getAttributes(
                    wetlab_config.SAMBA_SHARED_FOLDER_NAME, completion_file
                )
            ...
            try:
                conversion_attributes = conn.getAttributes(
                    wetlab_config.SAMBA_SHARED_FOLDER_NAME, conversion_stats_file
                )
                #
...
def configuration_test(request):
    ...
    if request.method == "POST" and request.POST["action"] == "basicTest":
        test_results = {}
        wetlab_config_file = os.path.join(
            settings.BASE_DIR, "iSkyLIMS_wetlab", "wetlab_config.py"
        )
