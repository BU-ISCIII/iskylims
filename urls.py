...
urlpatterns = [
    ...
    path('AddQCtoSample', views.add_qc_to_sample, name = 'add_qc_to_sample'),
    ...
    path('defineProtocolParameters', views.define_protocol_parameters, name = 'define_protocol_parameters'),
