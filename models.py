...
class RunProcess(models.Model):
    ...
    sequencerFamily=models.CharField(max_length=20,null=True, default="sequencerFamily")
    sequencerModel=models.CharField(max_length=20,null=True, default="sequencerModel")
